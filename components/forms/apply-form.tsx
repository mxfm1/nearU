...
export const ApplyForm = ({ slug, onSuccess }: ApplyFormProps) => {
  ...
  const handleFileUpload = async (
    ...
    try {
      ...
      form.setValue(
        'attachments',
        [...attachments, ...newItems].map((a) => a.url)
      );
      toast.success(
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleFormSubmit)} className="space-y-6">
            ...
            <FormItem>
              ...
              >
                <FormControl>
                  <SelectTrigger>
                    <SelectValue
                      placeholder={intencionesLoading ? 'Cargando...' : 'Selecciona una intención'}
                    />
                  </SelectTrigger>
                </FormControl>
                <SelectContent>
        ...
        <div className="space-y-3">
          <Label className="text-sm font-medium leading-none">Archivos adjuntos</Label>
            ...
            <div className="flex flex-wrap items-center gap-2">
              ...
              >
                ...
                <input
                  ...
                  accept="image/*"
                  onChange={(e) =>
                    handleFileUpload(e, 'contactAttachment', 'image', setUploadingImage)
                  }
              ...
              >
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleFileUpload(e, 'contactAttachmentDoc', 'pdf', setUploadingPdf)
                  }
                  className="absolute inset-0 opacity-0 cursor-pointer"
                  disabled={uploadingImage || uploadingPdf}
                />
              ...
              <span className="text-xs text-muted-foreground">{attachments.length}/6</span>
            </div>
          )}
        </div>
