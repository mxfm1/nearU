...
export function PrivacySection({
  ...
  return (
    <section>
      ...
      <p className="text-sm text-muted-foreground mb-4">Controla la visibilidad y el uso de tus datos.</p>
          ...
          <div>
            ...
            <div className="flex gap-3">
              ...
              >
                ...
                >
                  {profileVisibility === 'public' && <div className="w-2 h-2 rounded-full bg-brand" />}
                </div>
              ...
              >
                ...
                >
                  {profileVisibility === 'followers' && <div className="w-2 h-2 rounded-full bg-brand" />}
                </div>
                <div className="text-left">
