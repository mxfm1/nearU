  ...
  return (
    <div className="section-container pt-20 pb-12 md:pt-28 md:pb-16">
      <div className="mb-6 md:mb-8">
        <h1 className="text-2xl md:text-3xl font-bold text-foreground">Crear evento</h1>
      ...
      <p className="text-sm text-zinc-400 mt-4">
        **Si guardas como borrador, el evento estará guardado pero no se mostrará en la app. Lo
        puedes editar en tus publicaciones
      </p>
    </div>
  );
}
