...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        "gradient-brand": "linear-gradient(135deg, var(--gradient-start) 0%, var(--gradient-end) 100%)",
        "gradient-brand-radial": "radial-gradient(ellipse at top left, var(--gradient-start) 0%, var(--gradient-end) 100%)",
        "gradient-hero": "linear-gradient(180deg, var(--gradient-hero-start) 0%, var(--gradient-hero-end) 100%)",
      },
